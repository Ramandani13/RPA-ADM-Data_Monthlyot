...
sleep(2)
logoutscrol = pag.locateCenterOnScreen("logoutscrol.png")
pag.moveTo(logoutscrol)
pag.moveTo(logoutscrol.x + 70, logoutscrol.y + 780)
pag.click()

sleep(1)
rptam = pag.locateCenterOnScreen("rptap.png")
pag.moveTo(rptam)
...
sleep(3)
excel = pag.locateCenterOnScreen("excel.png")
pag.moveTo(excel)
pag.click()
